...
export function QuizCard({ question, selectedChoiceId, answered, onSelect, isFavorite = false, onToggleFavorite, favoriteGroups, favoriteGroupIds = [], onToggleFavoriteGroup, onCreateFavoriteGroup, onRenameFavoriteGroup, onDeleteFavoriteGroup }: QuizCardProps) {
