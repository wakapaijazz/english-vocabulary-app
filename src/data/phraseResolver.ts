...
const supplementalExamples = { ...phraseExampleCatalog, ...phraseExampleExpansion, ...phraseExampleExpansion2, ...phraseExampleExpansion3, ...phraseExampleExpansion4, ...phraseExampleRevision, ...phraseExampleRevision2 };
