...
import expansionData8 from "../src/data/vocabulary-expansion-8.json";
...
const entries = [...baseData, ...extraData, ...moreData, ...finalData, ...expansionData, ...expansionData2, ...expansionData3, ...expansionData4, ...expansionData5, ...expansionData6, ...expansionData7, ...expansionData8] as unknown as VocabularyEntry[];

describe("English to English quiz", () => {
  it("loads 1550 vocabulary entries", () => expect(entries).toHaveLength(1550));
