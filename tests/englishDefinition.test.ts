...
const entries = [...baseData, ...extraData, ...moreData, ...finalData, ...expansionData, ...expansionData2] as unknown as VocabularyEntry[];

describe("English to English quiz", () => {
  it("loads 800 vocabulary entries", () => expect(entries).toHaveLength(800));
